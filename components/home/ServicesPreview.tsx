      ...
      <div className="container mx-auto max-w-7xl px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
        ...
        <div className={`grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          {services.map((service, index) => (
            <Card key={index} className={`hover:shadow-xl transition-all duration-300 cursor-pointer group ${service.color} overflow-hidden`}>
              ...
              <CardHeader className="pb-4">
                <div className={`w-12 h-12 ${service.color} rounded-xl flex items-center justify-center mb-4 ${service.iconColor} group-hover:scale-110 transition-transform duration-300`}>
                  {service.icon}
                </div>
              ...
              <CardContent>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-600 mt-1">{service.benefits}</p>
                </div>
